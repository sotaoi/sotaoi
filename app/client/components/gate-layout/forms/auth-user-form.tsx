...
import { WebAuthUserForm } from '@app/client/components/gate-layout/forms/auth-user-form/web.auth-user-form';
import { MobileAuthUserForm } from '@app/client/components/gate-layout/forms/auth-user-form/mobile.auth-user-form';
