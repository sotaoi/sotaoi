...
import { Artifacts, RecordEntry } from '@sotaoi/omni/artifacts';
...
import { WebUpdateUserForm } from '@app/client/components/main-layout/forms/update-user-form/web.update-user-form';
...
class UpdateUserForm extends ViewComponent<UpdateUserFormProps> {
  ...
  public web(data: ViewData<UpdateUserFormProps>): null | React.ReactElement {
    ...
    return <WebUpdateUserForm form={form} />;
  }
